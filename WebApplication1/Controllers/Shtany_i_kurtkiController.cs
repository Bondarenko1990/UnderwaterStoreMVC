...
{
    public class Shtany_i_kurtkiController : Controller
    {
        UnitOfWork unitOfWork;

        public Shtany_i_kurtkiController()
        {
            unitOfWork = new UnitOfWork();
        }

        public FilterShtany_i_kurtki GetFilter()

        {
            FilterShtany_i_kurtki filter = (FilterShtany_i_kurtki)Session["FilterShtany_i_kurtki"];
            if (filter == null)
            {
                filter = new FilterShtany_i_kurtki();
                Session["FilterShtany_i_kurtki"] = filter;
            }
            return filter;
        }
        ...
        {
            Shtany_i_kurtki item = unitOfWork.Shtany_i_kurtkis.GetAll()
        ...
        public ViewResult Create()
        {
            ...
            return View("Edit", new Shtany_i_kurtki());
        }
        ...
        {
            Shtany_i_kurtki deletedItem = unitOfWork.Shtany_i_kurtkis.Delete(Id);
            if (deletedItem != null)
            {
        ...
        {
            return View(unitOfWork.Shtany_i_kurtkis.GetAll().ToList());
        }

        [Authorize(Roles = "Admin")]
        public ViewResult Edit(int Id)
        {
            Shtany_i_kurtki item = unitOfWork.Shtany_i_kurtkis.GetAll().FirstOrDefault(g => g.Id == Id);
            SelectList brands = new SelectList(unitOfWork.Brands.GetAll(), "Id", "Name");
            ViewBag.Brands = brands;
            return View(item);
        }
        ...
        [HttpPost]
        [Authorize(Roles = "Admin")]
        public ActionResult Edit(Shtany_i_kurtki item, HttpPostedFileBase image = null)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    item.ImageMimeType = unitOfWork.Shtany_i_kurtkis.Get(item.Id).ImageMimeType;
                    item.ImageData = unitOfWork.Shtany_i_kurtkis.Get(item.Id).ImageData;
                }
                unitOfWork.Shtany_i_kurtkis.SaveItem(item);
        ...
        {
            Shtany_i_kurtki c = unitOfWork.Shtany_i_kurtkis.GetAll().FirstOrDefault(com => com.Id == id);
            if (c != null)
        ...
        public PartialViewResult Models(int page = 1)
        {
            ...
            IEnumerable<Shtany_i_kurtki> GunsPerPages = GetFilter().Item.Skip((page - 1) * pageSize).Take(pageSize);
        ...
        public ActionResult List(int page = 1)
        {
            ...
            int count = unitOfWork.Shtany_i_kurtkis.GetAll().Count();
            var items = unitOfWork.Shtany_i_kurtkis.GetAll().OrderBy(t => Guid.NewGuid()).Take(count).ToList();
            List<Shtany_i_kurtki> Item;
            if (GetFilter().Item == null)
            {
                Item = unitOfWork.Shtany_i_kurtkis.GetAll().OrderBy(t => Guid.NewGuid()).Take(count).ToList();
            }
            else
            {
                Item = GetFilter().Item;
            ...
            //------------------------------------------------
            ViewBag.MinPrice = unitOfWork.Shtany_i_kurtkis.GetAll().Min(a => a.Price);
            ViewBag.MaxPrice = unitOfWork.Shtany_i_kurtkis.GetAll().Max(a => a.Price);
            ViewBag.CheckedMinPrice = GetFilter().CheckedMinPrice;
            if (GetFilter().CheckedMaxPrice == 0)
            {
                ViewBag.CheckedMaxPrice = unitOfWork.Shtany_i_kurtkis.GetAll().Max(a => a.Price);
            }
            else
            {
            ...
            IEnumerable<Shtany_i_kurtki> GunsPerPages = Item.Skip((page - 1) * pageSize).Take(pageSize);
            PageInfo pageInfo = new PageInfo
            {
                PageNumber = page,
                PageSize = pageSize,
        ...
        public ActionResult Filter(int MinPrice, int MaxPrice, string[] brand, string[] country, bool[] zashitaKoleni, bool[] zashitaLokti,
            string[] pokritieVneshnee, string[] pokritieVnutrenee,bool[] waterstopRukava, bool[] waterstopShtani,string[] type,decimal[] tolshina)
        {
            int count = unitOfWork.Shtany_i_kurtkis.GetAll().Count();
            List<Shtany_i_kurtki> Item = unitOfWork.Shtany_i_kurtkis.GetAll().Where(p => p.Price >= MinPrice && p.Price <= MaxPrice).ToList();
            List<Shtany_i_kurtki> newItem = new List<Shtany_i_kurtki>();
            ...
            if (country != null)
            {
                newItem = new List<Shtany_i_kurtki>();
                string a = "";
        ...
        {
            List<Shtany_i_kurtki> Item = GetFilter().Item;

            return Json(Item.Count());
        }
        
    }
    public class FilterShtany_i_kurtki
    {
        public List<Shtany_i_kurtki> Item { get; set; }
